...
lazy val commons = project
  ...
  .settings(
    libraryDependencies ++= Seq(
      ...
      "io.github.iltotore" %% "iron-cats" % "2.2.1" % Optional,
      "io.janstenpickle" %% "trace4cats-http4s-server" % "0.14.1" % Optional,
      "io.janstenpickle" %% "trace4cats-iolocal" % "0.14.5" % Optional,
      "org.flywaydb" % "flyway-core" % "9.21.1" % Optional,
...
lazy val `realworld-http` = project
  ...
  .settings(
    libraryDependencies ++= Seq(
      ...
      "io.github.iltotore" %% "iron-cats" % "2.2.1",
      ...
      "org.flywaydb" % "flyway-core" % "9.21.1" % Runtime,
